...
class bank_transfer_schedule(osv.osv):
    ...
    _columns = {
        ...
        'company_bank_name':fields.related('company_bank_id','bank', type='many2one',relation="res.bank", string='Company Bank Name', readonly=True,store=True),
        ...
        'entity_bank_id':fields.many2one('res.partner.bank','Account #',domain=[('ownership','=','entity')],help="Matches name of analytic account and partner name."),
